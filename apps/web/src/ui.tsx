...
export function AppLogo({ compact = false, inverse = false }: { compact?: boolean; inverse?: boolean }) {
  return <div className={`app-logo ${inverse ? 'inverse' : ''}`} aria-label="DealerOS">
    <span className="logo-symbol" aria-hidden="true">
      <svg viewBox="0 0 120 96" focusable="false">
        <rect x="1" y="1" width="118" height="94" rx="21" className="logo-symbol-tile" />
        <path className="logo-symbol-car" d="M25 34h45L60 24c-3-3-7-5-12-5H39l4-6h19c10 0 18 4 26 12l10 9h9c3 0 5 2 5 5 0 2-1 3-3 4l-4 1c8 4 12 10 12 17v13c0 2-2 4-4 4h-12V64c0-5-4-9-9-9H78c-5 0-9-3-11-8l-2-5H25Z" />
        <circle cx="18" cy="38" r="7" className="logo-symbol-car" />
        <circle cx="18" cy="38" r="3" className="logo-symbol-cutout" />
        <path className="logo-symbol-lime-line" d="M20 54h40c6 0 10 3 12 9l2 6c1 4 5 6 9 6h9" />
        <circle cx="14" cy="54" r="7" className="logo-symbol-lime" />
        <circle cx="14" cy="54" r="3" className="logo-symbol-cutout" />
        <circle cx="96" cy="75" r="7" className="logo-symbol-lime" />
        <circle cx="96" cy="75" r="3" className="logo-symbol-cutout" />
        <path className="logo-symbol-graphite-line" d="M27 69h30c6 0 10 3 13 8l2 3c2 3 5 5 10 5h29c0 5-4 8-9 8H80c-8 0-13-4-17-11-2-4-5-6-10-6H27" />
        <circle cx="20" cy="69" r="7" className="logo-symbol-graphite" />
        <circle cx="20" cy="69" r="3" className="logo-symbol-cutout" />
      </svg>
    </span>
    {!compact && <span className="logo-copy"><strong>DealerOS</strong><small>Управление автосалоном</small></span>}
  </div>
}
