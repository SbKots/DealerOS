...
- Bucket фото не публичен. Object key создаёт сервер и включает tenant/inspection/defect UUID; исходное имя не участвует в пути. Скачивание только через JWT + permission API.
